...
>(({ className, children, ...props }, ref) => {
   const renderChildren = () => {
      if (typeof children === "function") {
         return children({ pressed: false, hovered: false });
      }
      return children;
   };
...
const DialogTitle = React.forwardRef<DialogPrimitive.TitleRef, DialogPrimitive.TitleProps>(
   ({ className, ...props }, ref) => (
      <DialogPrimitive.Title
         ref={ref}
         className={cn(
            "text-lg native:text-xl text-foreground font-strong leading-none tracking-tight",
            className
         )}
         {...props}
      />
...
>(({ className, ...props }, ref) => (
   <DialogPrimitive.Description
      ref={ref}
      className={cn("text-sm native:text-base text-muted-foreground font-sans", className)}
      {...props}
   />
));
